...
const Web = () => (
  ...
  >
    ...
    <Flex position="relative" width="w-full" height="h-full" zIndex="z-2">
      <Flex width="w-86%" height="h-[144rem]">
        <Flex
          width="w-full"
        ...
        >
          <Flex width="w-full" direction="flex-col" gap="gap-2">
            <Text size="headline-l" color="c-on-primary-container">
              리딩방 운영을 쉽고 스마트하게
            </Text>
            <Text font="font-secondary" size="display-xl" color="c-on-neutral">
          ...
          <Flex width="w-full" direction="flex-col" gap="gap-3">
            ...
            <Flex width="w-full" direction="flex-col" gap="gap-2">
              <Text size="display-m" color="c-gs-pure-black">
      ...
      <Flex width="w-86%" height="h-[81rem]" justifyContent="jc-start">
        <ChatAdmin></ChatAdmin>
      </Flex>
      <Flex width="w-86%" height="h-[98rem]" justifyContent="jc-start">
        <Flex
          position="relative"
          width="w-full"
          direction="flex-col"
